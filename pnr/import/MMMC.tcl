...
create_constraint_mode -name func_mode -sdc_files {../dft/UART_TX_func.sdc}
create_constraint_mode -name scan_mode -sdc_files {../dft/UART_TX_scan.sdc}
create_constraint_mode -name capture_mode -sdc_files {../dft/UART_TX_capture.sdc}
