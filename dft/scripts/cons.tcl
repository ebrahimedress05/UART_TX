...
set_input_delay $in_delay -clock $CLK_NAME [get_ports {P_DATA Data_Valid PAR_EN PAR_TYP}]
...
set_output_delay $out_delay -clock $CLK_NAME [get_ports {TX_OUT Busy}]
...
#functional ports
set_driving_cell -library "scmetro_tsmc_cl013g_rvt_ss_1p08v_125c" -lib_cell BUFX2M [get_ports {P_DATA Data_Valid PAR_EN PAR_TYP}]
...
#functional ports
set loaded 0.5
set_load $loaded [get_ports {TX_OUT Busy}]

#scan ports
set_load $loaded  [get_port SO]
